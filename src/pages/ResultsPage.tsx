...
export function ResultsPage() {
  ...
  if (!state) {
    return (
      <div className="flex h-dvh flex-col items-center justify-center gap-4 px-6 text-center text-[var(--color-parchment)]">
        <PageCard className="flex flex-col items-center gap-4">
          <p>還沒有測驗結果。</p>
          <button
            type="button"
            onClick={() => navigate('/')}
