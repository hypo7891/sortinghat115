...
export const MAP_ZONES: MapZone[] = [
  {
    id: 'trials',
    label: '分類試煉庭院',
    intro: '歡迎來到新希望學院！穿過庭院，完成十二道分類試煉，看看你最常展現哪種特質。',
  ...
  },
  {
    ...
    themeColor: 'var(--color-composure)',
